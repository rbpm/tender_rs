use crate::dto::{ArgDto, OrderDto};
use crate::traits::{is_in_vec, Data};

pub fn get_order_pages(args: &ArgDto, old_all: Vec<Box<dyn Data>>) -> Vec<Box<dyn Data>> {
    let mut order_vec = Vec::<Box<dyn Data>>::new();
    for order_page in 1..args.order_pages + 1 {
...
pub fn get_order_page(
    mut order_vec: Vec<Box<dyn Data>>,
    order_page: u32,
